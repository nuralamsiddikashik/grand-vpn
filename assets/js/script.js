(function ($) {
    ...
    $('.dropdown-menu li').on('click',function(){
        $('.btn-group > .dropdown-menu').slideToggle();
    })
    $('.btn.dropdown-toggle').on('click',function() {
        $('.btn-group > .dropdown-menu').slideToggle();
    })
    $('.support-box-icon-wrapper,.support-close-btn button').on('click',function() {
        $('.support-box-wrapper').slideToggle();
    })
    $('.welcome-popup-close,.overlay-welcome').on('click',function() {
        $('.overlay-welcome,.welcome-popup').addClass('hidden-popup-welcome');
    })
